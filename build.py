...
LOCALES = {
    "en": {
        ...
        "desc": "Sidefeed shows the official YouTube trending chart for 12 countries, and how much each video climbed or dropped in the last 6 hours. A trend research app for creators planning their next video.",
        ...
        "sub": "Open YouTube and the algorithm shows you videos picked just for you — so it's surprisingly hard to see what everyone else is watching. Sidefeed shows you the official trending chart for 12 countries, exactly as it is, and tells you how much every video climbed or dropped in the last 6 hours. If you make videos for a living, your next idea starts here.",
        "badge_small": "Download on the", "note": "FREE DOWNLOAD · IPHONE &amp; IPAD · NO GOOGLE LOGIN",
        "badge_aria": "Download on the App Store",
        "chips": [["up", "▲9", "Rising-rank marks"], ["new", "N", "New-entry marks"], ["", "🌍", "12 countries"], ["", "🎵", "14 categories"]],
        ...
        "views_h2": "Four screens, <em>each with its own job</em>.",
        "views_lede": "Every screen is built on YouTube's public data, so everyone sees exactly the same thing — the actual trends, not what an algorithm guesses you want.",
        "views": [
    ...
    "ko": {
        ...
        "desc": "미국·일본·한국 등 12개 나라의 유튜브 공식 인기 차트를 그대로 보여주고, 각 영상의 순위가 6시간 동안 얼마나 오르내렸는지 알려줍니다. 다음 영상을 기획하는 크리에이터를 위한 트렌드 리서치 앱.",
        ...
        "sub": "유튜브를 열면 알고리즘이 '나에게 맞춘' 영상만 보여줍니다. 그래서 정작 세상 사람들이 지금 무엇을 보고 있는지는 알기 어렵죠. Sidefeed는 미국·일본·한국 등 12개 나라의 공식 인기 차트를 그대로 보여주고, 각 영상의 순위가 최근 6시간 동안 얼마나 올랐는지 내렸는지까지 알려줍니다. 영상을 만드는 사람이라면, 다음 영상 아이디어가 여기서 시작됩니다.",
        "badge_small": "다운로드는", "note": "무료 다운로드 · iPhone &amp; iPad · 구글 로그인 없음",
        "badge_aria": "App Store에서 다운로드",
        "chips": [["up", "▲9", "급상승 표시"], ["new", "N", "새 진입 표시"], ["", "🌍", "12개 나라"], ["", "🎵", "14개 분야"]],
        ...
        "rank_nums": [[18, 3], [9, 2], [None, 5], [4, 11]],
        "views_kicker": "구성", "views_num": "4개의 화면",
        "views_h2": "화면은 네 개, <em>하는 일이 다 다릅니다</em>.",
        "views_lede": "네 화면 모두 유튜브가 공개한 데이터로 만들어져요. 누가 보든 똑같은 화면이라, 알고리즘 추천에 가려진 진짜 트렌드를 볼 수 있습니다.",
        "views": [
    ...
    "ja": {
        ...
        "desc": "アメリカ・日本・韓国など12ヶ国のYouTube公式人気チャートをそのまま表示し、各動画の順位が6時間でどれだけ上下したかを教えてくれます。次の動画を企画するクリエイターのためのトレンドリサーチアプリ。",
        ...
        "sub": "YouTubeを開くと、アルゴリズムが「あなた向け」の動画ばかり見せてきます。だから、世界のみんながいま何を見ているのかは意外と分かりません。Sidefeedはアメリカ・日本・韓国など12ヶ国の公式人気チャートをそのまま表示し、各動画の順位が直近6時間でどれだけ上がったか・下がったかまで教えてくれます。動画を作る人なら、次の動画のアイデアはここから始まります。",
        "badge_small": "ダウンロードは", "note": "無料ダウンロード · iPhone &amp; iPad · Googleログイン不要",
        "badge_aria": "App Store でダウンロード",
        "chips": [["up", "▲9", "急上昇マーク"], ["new", "N", "NEW入りマーク"], ["", "🌍", "12の国"], ["", "🎵", "14ジャンル"]],
        ...
        "views_kicker": "構成", "views_num": "4つの画面",
        "views_h2": "画面は4つ、<em>役割はぜんぶ違います</em>。",
        "views_lede": "4つの画面はすべてYouTubeが公開しているデータで作られています。誰が見ても同じ画面なので、アルゴリズムのおすすめに隠れた本当のトレンドが見えます。",
        "views": [
